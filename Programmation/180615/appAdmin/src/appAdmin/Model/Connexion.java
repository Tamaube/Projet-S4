...
public class Connexion {
	...
	public Connexion() throws InstantiationException, IllegalAccessException{
		try{
		...
		String url = "jdbc:mysql://localhost/rock_n_clothes?" +
                "user=root&password=";
	...
	public ArrayList<Produit> getProduits() throws SQLException{
		...
		while(monResultat.next()){
        	...
        	resultats.add(new Produit(Main.sonControleurGeneral.sonControleurAdministration, resultatLigne.get(1).toString(),
