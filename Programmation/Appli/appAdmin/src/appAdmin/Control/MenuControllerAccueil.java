...
public class MenuControllerAccueil implements Initializable {
        ...
        @FXML
        private Button modifierStockPanel;
   ...
   /* public void setPrevScene(Scene scene){
    ...
    @FXML
    public void goToModifierStock(Event event) throws IOException {
       
       //Stage stage = new Stage();
    	  FXMLLoader loader2 = new FXMLLoader();
    	  loader2.setLocation(Main.class.getResource("view/fenetreModifierStock.fxml"));
          prevStage.setTitle("Modifier Stock");
          Pane myPane = null;
          myPane = loader2.load();
          Scene scene = new Scene(myPane);
          scene.getStylesheets().add("application/application.css");
          ...
          MenuControllerModifierStock controller2 = (MenuControllerModifierStock)loader2.getController();
         if(controller2 != null) controller2.setPrevStage(prevStage);  
    }
